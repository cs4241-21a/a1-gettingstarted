...
3. (max 5 points) Experiment with other HTML tags (links, images, tables, figcaption, canvas,  etc.) Each extra tag you use will get you 1 extra point for a maximum of 5 points. Be sure to describe the links you use in your README. 
